"""
Data validators for gym_trading_env.

This module provides comprehensive validation to prevent lookahead bias,
data contamination, and ensure data integrity for reinforcement learning
trading environments.

Basic Validators:
- TemporalOrderingValidator: Ensures monotonic timestamps
- SplitBoundaryValidator: Validates train/val/test split boundaries
- OHLCIntegrityValidator: Checks OHLC data integrity
- NormalizationValidator: Detects NaN, Inf, and extreme values

Advanced Bias Detectors:
- LookaheadBiasDetector: Detects normalization using future data
- FutureLeakDetector: Detects validation data in training
- SuspiciousPatternDetector: Detects unrealistic performance patterns
...
- validate_temporal_order: Function-based temporal validation
- validate_no_gaps: Function-based gap detection
- validate_split_boundaries: Function-based split validation
"""
...
# Backward-compatible function-based validators (for legacy code)
...
__all__ = [
    # New class-based validators (Issue #106)
    "BaseValidator",
    "ValidationResult",
    "TemporalOrderingValidator",
    "SplitBoundaryValidator",
    "OHLCIntegrityValidator",
    "NormalizationValidator",
    "LookaheadBiasDetector",
    "FutureLeakDetector",
    "SuspiciousPatternDetector",
    "ValidationSuite",
    # Backward-compatible function-based validators (legacy)
